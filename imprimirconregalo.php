...
function imprimiryrenviar() {
			window.print();
			setTimeout("document.location.href='imprimirotraregalo.php?otrocodigo=<?php echo $filas_resultado_venta_H['CodFac']?>'",5000);	
}
</script>
</head>
<body onLoad="imprimiryrenviar()">
   <div class="iz">
	<div class="titulo">
